...
//         assert!(
//             <<Contract as ContractConstructorExecutor>::Type as DecodeDispatch>::decode_dispatch(
...
//         input_bytes.extend(42i32.encode());
//         assert!(
//             <<Contract as ContractMessageExecutor>::Type as DecodeDispatch>::decode_dispatch(
//                 &mut &input_bytes[..]).is_ok()
//         );
//     }
//     // Invalid call with invalid selector (or empty input).
